<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="ShoppingCart.WebForms.Orders" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label4" runat="server" Text="Order Amount"></asp:Label>
                    </td>
                    <td colspan="2">
